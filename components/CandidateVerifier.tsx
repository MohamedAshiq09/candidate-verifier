...
//               name: jsonData.fields.name || '',
//               email: jsonData.fields.email || '',
//               phone: jsonData.fields.phone || '',
//               skills: jsonData.fields.skills || '',
//               experience: jsonData.fields.experience || '',
//               education: jsonData.fields.education || '',
//               address: jsonData.fields.address || '',
//               currentCompany: jsonData.fields.currentCompany || '',
...
export default function CandidateVerifier({ onSubmit, isLoading = false }: CandidateVerifierProps) {
  ...
  const validateForm = (): boolean => {
    ...
    defaultFields.forEach(field => {
      const value = candidateData[field.id]
      // Convert to string and then trim to handle both string and number values
